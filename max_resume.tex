...
\section{Programming Skills}
 \resumeSubHeadingListStart
   \item{
     \textbf{Languages:}{ Python, C, Java, JavaScript, Racket, HCL}
   }
   \item{\textbf{Technologies:}{ Terraform, SpringBoot, Linux, ThymeLeaf, Flask, Express, MongoDB, React}}
...
\section{Professional Experiences}
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItem{}
          {Part of the Services team, which allows for exposure to multiple parts of a backend system as well as games development process. Spun up microservices for the game shareholders. Using AWS to host the service and Jenkins for executing jobs for the service.}
     \resumeItem{}
