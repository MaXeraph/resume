...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
          \resumeItem{}
            {\textbf{Completed:} Computer Organization, Introduction to Software Engineering, Programming on the Web, Principles of Programming Languages}
          \resumeItem{}
            {\textbf{In-progress:} Introduction to Databases, Operating Systems, Engineering Large Software Systems, Algorithm Design, Analysis \& Complexity}
      \resumeItemListEnd
...
\section{Programming Skills}
 \resumeSubHeadingListStart
   \item{
     \textbf{Languages:}{ Python, C, Java, JavaScript, Racket}
   }
...
\section{Relevant Projects}
  ...
  \resumeSubheading
    ...
    {Project}{September 2019 - Ongoing}
    \resumeItemListStart
      \resumeItem{}
...
\section{Extra-Curricular Activities}
  \resumeSubHeadingListStart
    \resumeSubheading
      {\href{https://www.instagram.com/autonomousrobotclub/}{\underline{Autonomous Robotics Club}}}{Magee Secondary School}
